...
ggplot(gdpByState2017, aes(x = GeoName, y = q1_2017, fill = GeoName)) + geom_boxplot() + theme_light() + coord_flip()  + theme(axis.text.y=element_blank())
...
Update: Above issues addressed in [Portfolio: Part 2](https://violetinferno.github.io/DataSciencePortfolio/p2.html)
